        ...
        setContent {
            DANPLab05Theme() {
                ...
                val db = Room.databaseBuilder(
                    applicationContext,
                    CountryDatabase::class.java, "database-name"
                ).build()
                ...
                Surface(
                    ...
                    val repository =
                        CountryRepository(CountryDatabase.getInstance(context.applicationContext))
...
@Composable
fun Greeting(db: CountryRepository, modifier: Modifier = Modifier) {
...
fun fillWithStartingNotes(context: Context, repository: CountryRepository, scope: CoroutineScope) {
    try {
